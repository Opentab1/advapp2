...
import type { TimeRange, SensorData, HistoricalData, OccupancyMetrics, User } from '../types';
...
export function Dashboard({ user, onLogout }: DashboardProps) {
  ...
  if (!venueId) {
    return (
      <div className="min-h-screen flex items-center justify-center bg-gradient-to-br from-navy to-purple text-white">
        <ErrorMessage
          message="Your account is missing a venue assignment. Please contact support."
  ...
  const [currentLocationId, setCurrentLocationId] = useState<string>(initialLocationId);
