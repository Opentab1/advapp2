                  ...
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <div className="flex items-center gap-2 mt-1">
                        ...
                        <span className="text-xs text-warm-500">avg {song.avgCrowdSize ?? 0} people</span>
                      </div>
                    </div>
                    <div className="text-right">
                      <div className={`text-lg font-bold ${(song.retentionRate ?? 100) >= 100 ? 'text-emerald-400' : 'text-amber-400'}`}>
                      ...
                      <div className="text-xs text-warm-600 mt-0.5">
                        {(song.avgExitRate ?? 0).toFixed(1)} exit rate
                      </div>
                    </div>
                  </motion.div>
                ))
                ...
                topPerformersPlaylist.map((song, index) => (
                  ...
                  >
                    ...
                    <div className="flex items-center gap-2 flex-shrink-0">
                      ...
                      <span className={`text-xs ${(song.retentionRate ?? 100) >= 100 ? 'text-green-400' : 'text-amber-400'}`}>
                        {(song.retentionRate ?? 100) >= 100 ? '+' : ''}{((song.retentionRate ?? 100) - 100).toFixed(1)}%
                      </span>
                    </div>
                  </motion.div>
