  ...
  return (
    ...
    >
      ...
      <div className="flex items-center gap-2">
        ...
        <h3 className="font-semibold text-warm-800">Insights</h3>
      </div>
...
const TYPE_STYLES = {
  staff: 'border-l-purple-500 bg-purple-50',
  time: 'border-l-blue-500 bg-blue-50',
  environment: 'border-l-amber-500 bg-amber-50',
...
function InsightCard({ insight, index }: InsightCardProps) {
  ...
  return (
    <motion.div
      className={`p-3 rounded-r-xl border-l-4 ${style}`}
    ...
    >
      <div className="flex items-start gap-2">
        ...
        <div className="flex-1 min-w-0">
          <p className="font-medium text-warm-800 text-sm">{insight.title}</p>
