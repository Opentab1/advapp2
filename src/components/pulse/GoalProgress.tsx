    ...
    >
      ...
      <div className="flex items-center justify-between mb-2">
        <div className="flex items-center gap-2">
          ...
          <span className="font-medium text-warm-100">Weekly Goal</span>
        </div>
        {goal.achieved ? (
          <motion.span 
          ...
          <span className="text-xs text-warm-400">{daysLeft} days left</span>
        )}
      </div>
      ...
      <div className="mb-2">
        <div className="flex justify-between text-sm mb-1">
          <AnimatedNumber 
            ...
            className="font-bold text-warm-100"
          />
          <span className="text-warm-400">Target: {goal.target}</span>
        </div>
